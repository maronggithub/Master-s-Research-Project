...
while True:
    ...
    try:
        ...
        for d in dets:
            ...
            # cheek points
            vec_p[2][0] = (shape.part(13).x-shape.part(3).x)/3+shape.part(3).x
            vec_p[2][1] = shape.part(3).y
            vec_p[3][0] = shape.part(13).x-(shape.part(13).x-shape.part(3).x)/3
            vec_p[3][1] = shape.part(3).y
            vec_p[4][0] = (shape.part(14).x-shape.part(2).x)/4+shape.part(2).x
            vec_p[4][1] = shape.part(2).y
            vec_p[5][0] = shape.part(14).x-(shape.part(14).x-shape.part(2).x)/4
            ...
            # cheek side points
            vec_p[40][0] = shape.part(2).x
            vec_p[40][1] = shape.part(2).y
            vec_p[41][0] = shape.part(14).x
            vec_p[41][1] = shape.part(14).y
            vec_p[42][0] = shape.part(3).x
            vec_p[42][1] = shape.part(3).y
            vec_p[43][0] = shape.part(13).x
            vec_p[43][0] = shape.part(13).y
            vec_p[44][0] = shape.part(1).x
            vec_p[44][1] = shape.part(1).y
            vec_p[45][0] = shape.part(15).x
            vec_p[45][1] = shape.part(15).y
            # point of the middle of the lower eyelid
            # vec_p[46][0] = [shape.part(40).x + shape.part(41).x]/2
            # vec_p[46][1] = shape.part(40).y
            # vec_p[47][0] = [shape.part(47).x + shape.part(46).x] / 2
            # vec_p[47][1] = shape.part(47).y
            ...
            # cheek points
            vec_q[2][0] = (shape.part(13).x-shape.part(3).x)/3+shape.part(3).x-2
            vec_q[2][1] = (shape).part(3).y-5
            vec_q[3][0] = (shape.part(13).x-(shape.part(13).x-shape.part(3).x)/3)+2
            vec_q[3][1] = shape.part(13).y-5
            vec_q[4][0] = (shape.part(14).x-shape.part(2).x)/4+shape.part(2).x
            vec_q[4][1] = shape.part(2).y-3
            vec_q[5][0] = (shape.part(14).x-(shape.part(14).x-shape.part(2).x)/4)
            vec_q[5][1] = shape.part(2).y-3
            # lower eyelid points
            vec_q[6][0] = shape.part(40).x-1
            vec_q[6][1] = shape.part(39).y-1
            vec_q[7][0] = shape.part(47).x+1
            vec_q[7][1] = shape.part(42).y-1
            vec_q[8][0] = shape.part(41).x
            vec_q[8][1] = shape.part(39).y-3
            vec_q[9][0] = shape.part(46).x
            vec_q[9][1] = shape.part(42).y-3
            # upper lip points
            ...
            # cheek side points
            vec_q[40][0] = shape.part(2).x-6
            vec_q[40][1] = shape.part(2).y-8
            vec_q[41][0] = shape.part(14).x+6
            vec_q[41][1] = shape.part(14).y-8
            vec_q[42][0] = shape.part(3).x-5
            vec_q[42][1] = shape.part(3).y-6
            vec_q[43][0] = shape.part(13).x+5
            vec_q[43][0] = shape.part(13).y-6
            vec_q[44][0] = shape.part(1).x-3
            vec_q[44][1] = shape.part(1).y-5
            vec_q[45][0] = shape.part(15).x+3
            vec_q[45][1] = shape.part(15).y-5
            # point of the middle of the lower eyelid
            # vec_q[46][0] = [shape.part(40).x + shape.part(41).x] / 2
            # vec_q[46][1] = shape.part(40).y-15
            # vec_q[47][0] = [shape.part(47).x + shape.part(46).x] / 2
            # vec_q[47][1] = shape.part(47).y-15
            ...
            p = np.array([
                ...
                [vec_p[40][0], vec_p[40][1]], [vec_p[41][0], vec_p[41][1]],
                [vec_p[42][0], vec_p[42][1]], [vec_p[43][0], vec_p[43][1]],
                [vec_p[44][0], vec_p[44][1]], [vec_p[45][0], vec_p[45][1]]
                # [vec_p[46][0], vec_p[46][1]], [vec_p[47][0], vec_p[47][1]]
            ...
            q = np.array([
                ...
                [vec_q[40][0], vec_q[40][1]], [vec_q[41][0], vec_q[41][1]],
                [vec_q[42][0], vec_q[42][1]], [vec_q[43][0], vec_q[43][1]],
                [vec_q[44][0], vec_q[44][1]], [vec_q[45][0], vec_q[45][1]]
                # [vec_q[46][0], vec_q[46][1]], [vec_q[47][0], vec_q[47][1]]
            ])
