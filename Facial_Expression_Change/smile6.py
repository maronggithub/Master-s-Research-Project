...
while True:
    ...
    try:
        ...
        for d in dets:
            ...
            vec_p[21][1] = shape.part(15).y
            # inside of the mouth corner
            vec_p[22][0] = shape.part(39).x
            vec_p[22][1] = shape.part(39).y
            vec_p[23][0] = shape.part(42).x
            vec_p[23][1] = shape.part(42).y
            ...
            vec_q[5][1] = shape.part(14).y-3
            # the lower eyelid
            vec_q[6][0] = shape.part(40).x+1
            vec_q[6][1] = shape.part(40).y-1
            vec_q[7][0] = shape.part(47).x-1
            vec_q[7][1] = shape.part(47).y-1
            vec_q[8][0] = shape.part(41).x
            vec_q[8][1] = shape.part(41).y-3
            vec_q[9][0] = shape.part(46).x
            vec_q[9][1] = shape.part(46).y-3
            # upper lip
            ...
            # inside of the mouth corner
            vec_q[22][0] = shape.part(39).x
            vec_q[22][1] = shape.part(39).y
            vec_q[23][0] = shape.part(42).x
            vec_q[23][1] = shape.part(42).y
            ...
            q = np.array([
                ...
                [vec_q[20][0], vec_q[20][1]],[vec_q[21][0], vec_q[21][1]],[vec_q[22][0], vec_q[22][1]], [vec_q[23][0], vec_q[23][1]]
